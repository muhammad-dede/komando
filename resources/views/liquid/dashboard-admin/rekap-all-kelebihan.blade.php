...
@section('title')
    @include('components.form-filter-report-liquid-2', ['title' => 'Rekap Semua ' . $config->lebih])
@stop
            ...
            <div class="card-box width-full">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-right">
                            {{-- <a href="{{ route('dashboard-admin.rekap-kelebihan.download', request()->only('periode', 'company_code', 'unit_code')) }}"
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xs-12">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 mar-t-1rem"></div>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 mar-t-1rem">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($data['kelebihan'] as $kelebihan)
                                            <tr>
                                                <td>{{ $index += 1 }}</td>
                                                <td>{{ $kelebihan['kelebihan'] }}</td>
                                                <td>{{ round(($kelebihan['jml_data'] * 100) / $data['voter'], 2) }} %
                                                </td>
