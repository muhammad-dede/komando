<div class="modal fade" id="pengukuran-satu{{ $atasan['atasan_snapshot']['nip'] }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header border-unset">
                <span class="title title-top" id="exampleModalLabel">Pengukuran Pertama</span>
                ...
                <div class="table-responsive">
                    <table class="table tabel-border datatable-modal" border="1">
                        ...
                        <tr>
                            ...
                            <th>NIP</th>
                            <th>Jabatan</th>
                            <th>Status Pengukuran Pertama</th>
                        ...
                        @foreach($atasan['peserta'] as $dataBawahan)
                            <tr>
                                ...
                                <td>
                                    @if ($dataBawahan['has_pengukuran_pertama'])
                                ...
                                @if (auth()->user()->can('liquid_send_notification_bawahan'))
                                    <td>
                                        <form action="{{ route('dashboard-admin.liquid-peserta.notify', $dataBawahan['liquid_peserta_id']) }}" method="get">
                                            <input type="hidden" name="jenis_kegiatan" value="Pengukuran Pertama">
