...
@section('title')
    <div class="row">
        ...
        <div class="col-md-6 col-lg-6 col-xs-12 lh-70 align-right">
            <a href="{{ url('dashboard-atasan/liquid-jadwal') }}" class="btn btn-primary"><em
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <div class="row">
                                            <div class="col-md-6 col-md-offset-3 col-xs-12 col-lg-6 col-lg-offset-3 ">
                                                @include('liquid.components.spider-chart-penilaian', ['resolusi' => $detail['resolusi']])
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
			$('#datatable_kelebihan').DataTable();
			$('#datatable_kekurangan').DataTable();
