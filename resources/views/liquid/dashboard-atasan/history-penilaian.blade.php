...
{{-- @php($resolusi = $liquidService->resolusi(auth()->user()->strukturJabatan->pernr)) --}}
...
@section('content')
    ...
    <div class="row m-t-20 dashboard-atasan-content">
        ...
        <div class="col-md-8 col-lg-8 col-xs-12 pull-right">
            <form action="{{ url('dashboard-atasan/history-penilaian') }}" method="get">
                <div class="row">
            ...
            @include('liquid.components.spider-chart-penilaian')
        </div>
    </div>
