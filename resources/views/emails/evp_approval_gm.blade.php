...
?>
                        ...
                        <p style="text-align: justify;text-justify: inter-word;">
                            ...
                            <br>
                            Dengan ini kami sampaikan permohonan persetujuan keikutsertaan Employee Volunteer Program sebagai berikut:
                ...
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: justify;text-justify: inter-word;">
                            Email persetujuan ini ditujukan kepada Bapak/Ibu dikarenakan Bapak/Ibu adalah sebagai General Manager.
                        </p>
                        <p style="text-align: justify;text-justify: inter-word;">
                            Jika Bapak/Ibu menyetujui semua relawan yang diajukan untuk mengikuti program tersebut, silakan Klik tombol "Approve All" pada halaman Detil Relawan pada aplikasi KOMANDO.
                        </p>
                        <p style="text-align: justify;text-justify: inter-word;">
                            Namun jika Bapak/Ibu tidak menyetujui pegawai untuk mengikuti program tersebut, silakan Klik tombol "Reject" pada halaman Detil Relawan pada aplikasi KOMANDO.
                ...
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: left;text-justify: inter-word;">
                            Klik tombol di bawah ini untuk melihat daftar relawan yang diajukan:
                        </p>
                ...
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: left;text-justify: inter-word;">
                            Atau klik tombol di bawah ini untuk melihat informasi lebih lanjut mengenai Kegiatan Employee Volunter Program:
                        </p>
                        <table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#2960b8"
                            ...
                            <tr>
                                <td height="30" align="center">
                                    <a href="{{url('evp/detail/'.$evp["id_evp"])}}" target="_blank"
                                       style="font-family: Helvetica; line-height: 2.5; font-size: 18px;
                                           letter-spacing: 0px; color: #ffffff; text-decoration: none;
                                           font-weight: regular; padding: 13px 20px;">
                                        Detil Kegiatan
