        ...
        {{--<td>--}}
            <table width="700" align="center" style="margin-top: 25px;">
                        ...
                        <table width="700" border="0" align="center" cellpadding="0"
                            ...
                            <tr>
                                <td align="center" style="line-height: 0px;text-align:center; ">
                                    <a href="https://budaya.pln.co.id/coc" target="_blank">
                                    <img style="display: block; line-height: 0px; font-size: 0px; border: 0px;" class="img1"
                                         src="https://budaya.pln.co.id/assets/images/create-jadwal.png"
                ...
                <tr>
                    <td style="padding: 10px;text-align: justify;text-justify: inter-word;">
                        ...
                        <p style="text-align: justify;text-justify: inter-word;">
                            ...
                            <br>
                            Berikut adalah informasi Materi {{$materi['jenis']}} yang telah diterbitkan:
                        </p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px;">
                        <table width="700" style="margin-left: 50px;">
                            {{--<tr>--}}
                                {{--<td style="padding: 10px; border-bottom: 1px solid #e4e4e4;border-top: 1px solid #e4e4e4;">Judul CoC</td>--}}
                                {{--<td>:</td>--}}
                                {{--<td style="font-size: 14px;padding: 10px; border-bottom: 1px solid #e4e4e4;border-top: 1px solid #dddddd;">--}}
                                    {{--<b>{{$materi['judul']}}</b>--}}
                                {{--</td>--}}
                            {{--</tr>--}}
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;border-top: 1px solid #e4e4e4;">Tema</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;border-top: 1px solid #e4e4e4;">{{$materi['tema']}}</td>
                            </tr>
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Jenis Materi</td>
                                {{--<td>:</td>--}}
                                @if($materi['energize_day'] == '1')
                                    <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Energize Day</td>
                                @elseif($materi['rubrik_transformasi'] == '1')
                                    <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Rubrik Transformasi</td>
                                @else
                                    <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Materi {{$materi['jenis']}}</td>
                                @endif
                            </tr>
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Judul</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">
                                    {{$materi['judul']}}
                                </td>
                            </tr>
                            @if($materi['energize_day'] =='')
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Penulis</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">
                                    {{$materi['penulis']}} ({{$materi['jabatan_penulis']}})
                                </td>
                            </tr>
                            @endif
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Tanggal</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">
                                    {{$materi['tanggal']}}
                                </td>
                ...
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: justify;text-justify: inter-word;">
                            Email ini mengingatkan kepada Bapak/Ibu sebagai Admin CoC untuk merencanakan
                            jadwal CoC di unit Anda berdasarkan materi yang telah dibuat.
                        </p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: left;text-justify: inter-word;">
                            Klik tombol di bawah ini untuk membuat jadwal CoC:
                        </p>
