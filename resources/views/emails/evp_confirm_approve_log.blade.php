...
?>
                        ...
                        <p style="text-align: justify;text-justify: inter-word;">
                            ...
                            <br>
                            Dengan ini kami sampaikan bahwa aktivitas relawan Employee Volunteer Program sebagai berikut telah disetujui oleh atasan langsung:
                ...
                {{--<tr>--}}
                    {{--<td style="padding: 10px;">--}}
                        {{--<p style="text-align: justify;text-justify: inter-word;">--}}
                            {{--Email persetujuan ini ditujukan kepada Bapak/Ibu dikarenakan Bapak/Ibu adalah atasan dari pegawai yang bersangkutan.--}}
                        {{--</p>--}}
                        {{--<p style="text-align: justify;text-justify: inter-word;">--}}
                            {{--Jika Bapak/Ibu menyetujui aktivitas pegawai yang bersangkutan, silakan Klik tombol "Approve" pada halaman Activity Log pada aplikasi KOMANDO.--}}
                        {{--</p>--}}
                        {{--<p style="text-align: justify;text-justify: inter-word;">--}}
                ...
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: left;text-justify: inter-word;">
                            Klik tombol di bawah ini untuk melihat detil aktivitas relawan:
                        </p>
