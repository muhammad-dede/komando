                            ...
                            <tr>
                                <td align="center" style="line-height: 0px;text-align:center; ">
                                    ...
                                    <img style="display: block; line-height: 0px; font-size: 0px; border: 0px;" class="img1"
                                         src="https://budaya.pln.co.id/assets/images/check-in.png"
                                         alt="Check In" width="700" height="auto" align="center">
                                    </a>
                                </td>
                            </tr>
                        </table>
...
?>
                        ...
                        <p style="text-align: justify;text-justify: inter-word;">
                            ...
                            <br>
                            Berikut kami informasikan jadwal Code of Conduct {{$coc['jenis']}} yang telah direncanakan:
                        </p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px;">
                        <table width="700" style="margin-left: 50px;padding: 10px;">
                            ...
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Tema</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">{{$coc['tema']}}</td>
                            </tr>
                            {{--<tr>--}}
                                {{--<td>Jenis CoC</td>--}}
                                {{--<td>:</td>--}}
                            ...
                            {{--</tr>--}}
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Leader</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">
                                    {{$coc['leader']}} ({{$coc['jabatan_leader']}})
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Organisasi</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">
                                    {{$coc['organisasi']}}
                                </td>
                            ...
                            <tr>
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">Jam</td>
                                {{--<td>:</td>--}}
                                <td style="padding: 10px; border-bottom: 1px solid #e4e4e4;">
                                    {{$coc['jam']}}
                                </td>
                ...
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: justify;text-justify: inter-word;">
                            Email ini mengingatkan kepada Bapak/Ibu untuk mengikuti CoC di unit Bapak/Ibu
                            berdasarkan jadwal yang telah direncanakan.
                        </p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: left;text-justify: inter-word;">
                            Klik tombol di bawah ini untuk melihat kalender CoC:
                        </p>
                ...
                <tr>
                    <td style="padding: 10px;">
                        <p style="text-align: left;text-justify: inter-word;">
                            Atau klik tombol di bawah ini untuk melakukan Check-in:
                        </p>
