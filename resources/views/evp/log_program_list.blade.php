            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                @foreach($evp_list as $evp)
                    <tr>
                        ...
                        <td align="right">
                            {{$evp->waktu_awal->diffInDays($evp->waktu_akhir)}}
                        </td>
                        <td align="right">
                            {{number_format($evp->volunteers()->whereIn('status',['BRFG','ACTV','COMP'])->get()->count(),0,',','.')}}
                        </td>
                        {{--<td align="right">--}}
                            {{--<div class="row" style="">--}}
