...
@section('title')
    <h4 class="page-title">Edit Activity Log : {{$evp->nama_kegiatan}}</h4>
@stop

@section('content')
    {!! Form::open(['url'=>'/evp/log/edit/'.$log->id, 'files'=>true]) !!}
    <div class="row">
        <div class="col-md-12">
            @if (count($errors) > 0)
                        ...
                        <div class="row">
                            <div class="col-md-7 col-xs-12">
                                <div class="form-group {{($errors->has('aktivitas'))?'has-danger':''}}" style="">
                                    ...
                                    <div style="padding: 10px 10px 10px 10px;">
                                        {!! Form::textarea('aktivitas', $log->aktivitas, ['class'=>'form-control form-control-danger', 'id'=>'aktivitas',
                            ...
                            <div class="col-md-5">
                                <div class="form-group {{($errors->has('tanggal') || $errors->has('jam'))?'has-danger':''}}">
                                    ...
                                    <div class="row">
                                        <div class="input-group col-md-6">
                                            {!! Form::text('tanggal',($log->waktu!=null)?$log->waktu->format('d-m-Y'):null, ['class'=>'form-control form-control-danger', 'id'=>'tanggal', 'placeholder'=>'dd-mm-yyyy', 'autocomplete'=>'off']) !!}
                                        ...
                                        <div class="input-group clockpicker col-md-6" data-placement="top"
                                             data-align="top"
                                             data-autoclose="true">
                                            {!! Form::text('jam',($log->waktu!=null)?$log->waktu->format('H:i'):null, ['class'=>'form-control form-control-danger', 'id'=>'jam', 'placeholder'=>'Masukkan Jam', 'autocomplete'=>'off']) !!}
                                ...
                                <div class="form-group {{($errors->has('lokasi'))?'has-danger':''}}">
                                    ...
                                    <div>
                                        {!! Form::text('lokasi',$log->lokasi, ['class'=>'form-control form-control-danger', 'id'=>'lokasi', 'placeholder'=>'Lokasi']) !!}
                                    </div>
                                </div>
