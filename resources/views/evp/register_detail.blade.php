...
@section('content')
    {{--    {!! Form::open(['url'=>'evp/register/5', 'files'=>true]) !!}--}}
    <div class="row">
        <div class="col-md-12">
            @if (count($errors) > 0)
        ...
        <div class="col-xs-12">
            <div class="card-box">
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row m-t-20">
                            <div class="col-md-7 col-xs-12">
                                ...
                                <div class="form-group {{($errors->has('answer_tertarik'))?'has-danger':''}}"
                                    ...
                                    <h5 for="answer_tertarik" class="form-control-label"><i class="fa fa-comments-o"
                                                                                            style="font-size: 25px;"></i> {{$volunteer->nama}}
                                        tertarik untuk
                                        menjadi relawan pada kegiatan ini karena:</h5>

                                    <div style="padding: 10px 10px 10px 10px; border: 1px solid #e3e3e3; border-radius: 5px;">
                                        {{--<div class="form-group {{($errors->has('answer_tertarik'))?'has-danger':''}}" style="margin-top: 50px;">--}}
                                        {{--<h5 for="answer_tertarik" class="form-control-label">{{$volunteer->nama}} tertarik untuk--}}
                                        {{--menjadi relawan pada kegiatan ini karena:</h5>--}}
                                        ...
                                        {{--                                        'placeholder'=>'Masukkan jawaban Anda', 'rows'=>'20']) !!}--}}
                                ...
                                <div class="form-group {{($errors->has('answer_tertarik'))?'has-danger':''}}"
                                    ...
                                    <h5 for="answer_tertarik" class="form-control-label"><i class="fa fa-comments-o"
                                        ...
                                        Yang bersangkutan adalah relawan
                                        yang tepat untuk kegiatan ini karena:</h5>

                                    <div style="padding: 10px 10px 10px 10px; border: 1px solid #e3e3e3; border-radius: 5px;">
                                        {{--<div class="form-group {{($errors->has('kriteria_peserta'))?'has-danger':''}}">--}}
                                        {{--<h5 for="answer_tepat" class="form-control-label">Menurut {{$volunteer->nama}}, yang bersangkutan adalah relawan--}}
                                        {{--yang tepat untuk kegiatan ini karena:</h5>--}}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{($errors->has('file_cv'))?'has-danger':''}}">
                                    <label for="file_cv" class="form-control-label">Form Data Diri</label>
                                ...
                                <div class="form-group {{($errors->has('file_surat_pernyataan'))?'has-danger':''}}">
                                    <label for="file_surat_pernyataan" class="form-control-label">Surat
                                        Pernyataan</label>
                                ...
                                <div class="form-group {{($errors->has('file_surat_ijin_keluarga'))?'has-danger':''}}">
                                    <label for="file_surat_ijin_keluarga" class="form-control-label">Surat Ijin
                                        Keluarga</label>
                                ...
                                <div class="form-group {{($errors->has('file_surat_sehat'))?'has-danger':''}}">
                                    <label for="file_surat_ijin_keluarga" class="form-control-label">Surat Keterangan
                                        Sehat</label>
                    ...
                    <div role="tabpanel" class="tab-pane fade in " id="status" aria-labelledby="status-tab">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="">
                                    <table class="table">
                                        ...
                                        @foreach($volunteer->statusVolunteer()->orderBy('id', 'desc')->get() as $status)
                                            <tr>
                                                <td scope="row">
                                                    ...
                                                    @elseif($status->status == 'APRV-AT' || $status->status == 'APRV-ADM' || $status->status == 'APRV-GM' || $status->status == 'APRV-PST')
                                                        <button class="btn waves-effect btn-success"><i
                                                                    class="fa fa-check"></i></button>
                                                    @elseif($status->status == 'REJ-AT' || $status->status == 'REJ-ADM' || $status->status == 'REJ-GM' || $status->status == 'REJ-PST')
                                                        <button class="btn waves-effect btn-danger"><i
                                                                    class="fa fa-times"></i></button>
                                                    @elseif($status->status == 'BRFG')
                                                        <button class="btn waves-effect btn-success"><i
                                                                    class="fa fa-institution"></i></button>
                                                ...
                                                <td width="200" class="hidden-md-down">
                                                ...
                                                <td width="200">
                                                    @if($status->approver_id!=null)
                                                        @if($status->status == 'APRV-AT' || $status->status == 'APRV-ADM' || $status->status == 'APRV-GM' || $status->status == 'APRV-PST')
                ...
                <div class="row m-t-20">
                    ...
                    <div class="col-md-6 pull-right">
                        <div class="button-list">
                            ...
                            @elseif($volunteer->approval_admin==null && $volunteer->evp->reg_admin_lv1=='1' && Auth::user()->hasRole('admin_evp') && $volunteer->status=='APRV-AT')
                                <a href="javascript:" data-toggle="modal" data-target="#rejectModal"
                                   class="btn btn-danger btn-lg waves-effect waves-light pull-right"
                                   title="Reject"
                                ...
                                <a href="javascript:"
                                   class="btn btn-success btn-lg waves-effect waves-light pull-right"
                                   title="Approve"
                                   onclick="javascript:if(confirm('Apakah Anda yakin ingin menyetujui pegawai tersebut untuk mengikuti kegiatan ini?')){window.location.href='{{url('evp/approval/'.$volunteer->id.'/2')}}'}">
                                    <i class="fa fa-check"></i> Approve
                                </a>
                            @elseif($volunteer->approval_gm==null && $volunteer->evp->reg_gm=='1' && Auth::user()->isGM() && $volunteer->status=='APRV-ADM')
                                <a href="javascript:" data-toggle="modal" data-target="#rejectModal"
                                   class="btn btn-danger btn-lg waves-effect waves-light pull-right"
                                   title="Reject"
                            ...
                            @elseif($volunteer->approval_pusat==null && Auth::user()->can('evp_approve') && $volunteer->status=='APRV-GM')
                                ...
                                <a href="javascript:"
                                   class="btn btn-success btn-lg waves-effect waves-light pull-right"
                                   title="Approve"
                                   onclick="javascript:if(confirm('Apakah Anda yakin ingin menyetujui pegawai tersebut untuk mengikuti kegiatan ini?')){window.location.href='{{url('evp/approval/'.$volunteer->id.'/4')}}'}">
                                    <i class="fa fa-check"></i> Approve
                                </a>
                            @else
                            @endif
