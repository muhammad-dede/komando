...
@section('title')
    <h4 class="page-title">Status CoC Company Code</h4>
@stop
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                {!! Form::open(['url'=>'report/status-coc-cc', 'method' => 'get']) !!}
                <div class="form-group row">
                    <div class="col-md-3">
                        @if ($user->hasRole('admin_pusat') || $user->hasRole('root') || $user->hasRole('admin_ki'))
                            {!!
                                Form::select(
                                    'company_code',
                                    $ccList,
                    ...
                    <div class="col-md-4 button-list">
                        ...
                        <a href="{{url('report/status-coc-cc/export/' . $cc_selected . '/'.$tgl_awal->format('d-m-Y').'/'.$tgl_akhir->format('d-m-Y').'/'.$status_coc)}}" id="post" type="submit"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#datatable').DataTable({
                ...
                bPaginate: true,
                ajax: {
                    url: "{{ route('data_table.report.status.coc.cc') }}",
                    data: function (d) {
