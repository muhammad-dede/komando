...
@section('title')
    ...
    <div class="row">
        <div class="col-sm-8">
            <h1 class="mainTitle">Display User</h1>
            <span class="mainDescription">show registered users</span>
        </div>
        <ol class="breadcrumb">
            <li>
    ...
    @section('content')
    {!! Form::open(['url'=>'user-management/user/'.$user->id]) !!}
            <!-- start: USER PROFILE -->
    <div class="container-fluid container-fullw bg-white">
        <div class="form-horizontal">
            <div class="form-group col-md-12">
                ...
                {{--</label>--}}
                <div class="col-md-2">
                    {!! Form::text('id_user', str_pad($user->id,10,'0', STR_PAD_LEFT), ['class'=>'form-control underline', 'readonly'=>'', 'id'=>'id_user']) !!}
                </div>
                <div class="col-sm-4">
                    {!! Form::text('system_status', $user->status, ['class'=>'form-control underline', 'readonly'=>'']) !!}
                </div>
                <div class="col-sm-4">
                    <p>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Username"
                                                           ...
                                                           @if($user->domain!='esdm') readonly @endif>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">
                                                        Name
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if($user->business_area!=null)
                                                        {!! Form::select('business_area', $bsAreaList, $user->business_area,
                                                        ['class'=>'js-example-placeholder-single js-states form-control',
                                                        'id'=>'business_area', 'style'=>'width: 500px;']) !!}
                                                    @else
                                                        {!! Form::select('business_area', $bsAreaList, null,
                                                        ['class'=>'js-example-placeholder-single js-states form-control',
                                                        'id'=>'business_area', 'style'=>'width: 500px;']) !!}
                                                    @endif
