                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group {{($errors->has('jml_peserta'))?'has-danger':''}}">
                                            ...
                                            <div>
                                                {!! Form::number('jml_peserta',null, ['class'=>'required form-control form-control-danger', 'id'=>'jml_peserta', 'placeholder'=>'']) !!}
                            ...
                            <section>
                                ...
                                <div class="tab-content" id="subTabContentPelanggaran">
                                    <div role="tabpanel" class="tab-pane fade in active" id="pelanggaran-general"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="overflow: auto;height: 450px;" id="tabel_pelanggaran">
