...
@section('title')
    <h4 class="page-title">Edit Materi CoC</h4>
@stop
...
@section('content')
    ...
    {{--</div>--}}
    {{--</div>--}}
    {!! Form::open(['url'=>'master-data/materi/'.$materi->id, 'files'=>true]) !!}
    <div class="row">
        <div class="col-md-12">
            @if (count($errors) > 0)
                ...
                <div class="row">
                    <div class="col-md-8 p-20">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                {!! Form::text('judul', $materi->judul, ['class'=>'form-control', 'id'=>'topik', 'placeholder'=>'Judul Materi']) !!}
                            </div>
                        </div>
                        {{--<div class="form-group">--}}
                            {{--<label for="tanggal"--}}
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                {!! Form::textarea('deskripsi', $materi->deskripsi, ['class'=>'form-control', 'id'=>'deskripsi',
                    ...
                    <div class="col-md-4 p-20">
                        ...
                        <div class="form-group {{($errors->has('energize_day'))?'has-danger':''}}" align="left">
                            ...
                            <div class="switchery-demo">
                                ...
                                <input type="checkbox" data-plugin="switchery" data-color="#039cfd" value="1" name="energize_day" id="energize_day" {{($materi->energize_day=='1')?'checked':''}}/>
                                {{--<h4>Energize Day</h4>--}}
                            </div>

                        </div>
                        @endif
                        <div class="form-group" id="penulis" style="display:{{($materi->energize_day=='1')?'none':'block'}}">
                            <label for="pemateri_id" class="form-control-label">Penulis</label>
                                {{@$materi->penulis->cname}}
                            <div>
                        ...
                        <div class="form-group">
                            ...
                            @if($attachment != null)
                            <a href="{{url('coc/atch/'.$attachment->id)}}" target="_blank">
