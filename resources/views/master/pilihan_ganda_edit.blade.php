...
@section('content')
    {!! Form::open(['url'=>'master-data/pertanyaan/pilihan-ganda/'.$pertanyaan->id.'/edit','class'=>'form_control']) !!}
    <div class="row">
        <div class="col-xs-12">
            <div class="card-box">
                ...
                <fieldset class="form-group">
                    ...
                    <textarea class="form-control" id="pertanyaan" name="pertanyaan" rows="2">{{$pertanyaan->pertanyaan}}</textarea>
                </fieldset>
                <div class="row">
                    <div class="col-md-10">
                        <label>Jawaban</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row {{($jawaban->benar==1)? 'has-success' : ''}}" id="row_jawaban_{{$x}}">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::text('jawaban_'.$x,$jawaban->jawaban,['class'=>($jawaban->benar==1) ? 'form-control form-control-success' : 'form-control', 'id'=>'jawaban_'.$x]) !!}
                                </div>
                    ...
                    <div class="col-md-12 pull-right">
                        <div class="button-list">
                            <button type="button" class="btn btn-warning btn-lg pull-right"
                                    onclick="window.location.href='{{(!isset($pertanyaan)) ? url('master-data/pertanyaan') : url('master-data/pedoman-perilaku/'.$pertanyaan->pedomanPerilaku->id.'/display')}}';"><i
