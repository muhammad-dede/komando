...
@section('title')
    <h4 class="page-title">Komitmen Dewan Komisaris</h4>
@stop
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                {!! Form::open(['url'=>'report/commitment-dekom', 'method' => 'GET']) !!}
                <div class="form-group row">
                    ...
                    <div class="col-md-6 button-list">
                        ...
                        {{--@endif--}}
                        <a href="{{url('report/commitment-dekom/export/'.$tahun)}}" id="post" type="submit"
