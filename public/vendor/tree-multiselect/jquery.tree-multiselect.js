...
function UiBuilder($el, hideSidePanel) {
  ...
  var $selected = jQuery('<div class="selected"><div class="selection">Your Selection</div></idv></div>');
  if (!hideSidePanel) {
...
exports.createSelected = function (astItem, disableRemoval, showSectionOnSelected) {
  ...
  var inputHidden = exports.createNode('input', { name: 'business_area[]', type: 'hidden', value: astItem.value});
  node.appendChild(inputHidden);
  var inputHidden = exports.createNode('span', { class: 'hidden-el', text: astItem.text});
  node.appendChild(inputHidden);
